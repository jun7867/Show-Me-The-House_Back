...
<html>
	...
	<body>
	  <!-- Page Header --> 
  <header class="masthead" style="background-image: url('img/mainhome.jpeg')">
...
<div class="form-check-inline" style="margin-left: 30px;">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" value="" checked>All
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" value="">아파트매매
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="checkbox" class="form-check-input" value="">주택매매
  </label>
</div>
...
<div class="form-row">
      <div class="col-12 col-md-10 mb-2 mb-md-0">
        <input type="email" class="form-control form-control-lg" placeholder="지역 또는 단지명을 입력하세요.">
      </div>
	...
	<div class="row">
		<div class="col-sm-8">
		        <!-- Embedded Google Map -->
		        <iframe style="width: 100%; height: 1000px; border: 0;" src="http://maps.google.com/maps?hl=en&amp;ie=UTF8&amp;ll=37.0625,-95.677068&amp;spn=56.506174,79.013672&amp;t=m&amp;z=4&amp;output=embed"></iframe>
	    </div>
	    <div class="col-sm-4" id="housedeal__des" style="cursor: pointer;" onClick="location.href='houseview.html'">
	    	<h2>거래 정보</h2>
	    ...
	    <c:choose>
	    	...
	    	<c:otherwise>
	    		<c:forEach var="housedeal" items="${list}">
	    			<tr>
	    			<td>${housedeal.no} ${housedeal }</td>
	    			<td><a href="${root}/main.do?action=search&no=${housedeal.no}">${housedeal.dong}</a></td>
